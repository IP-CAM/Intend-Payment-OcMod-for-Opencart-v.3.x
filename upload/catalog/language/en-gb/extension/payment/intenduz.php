<?php
// Text
$_['text_title'] = '<img style="width: 90px;" src="catalog/view/theme/default/image/intend-logo.png" alt="Intend Payment" title="Intend Payment" />';
...
$_['entry_duration'] = 'Month';

$_['button_confirm'] = 'Pay with Intend';